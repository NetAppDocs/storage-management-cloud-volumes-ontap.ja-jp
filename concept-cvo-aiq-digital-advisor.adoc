...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^]（Digital Advisor とも呼ばれます）は、NetApp Console に統合されており、Cloud Volumes ONTAP システムの運用、セキュリティ、およびパフォーマンスを単一の画面で最適化できます。
