...
+
たとえば、 Cloud Volumes ONTAP 9.15.0を使用したすべてのシングルノード展開では、 `ontap_cloud_byol` SKU 名として。
...
----
+
URLは標準的な形式に従います。自動化のために、以下のようにURL文字列を導出できます。または、Azure CLI `az`コマンドを使用してURLを取得することもできます。URLの例：+https://examplesaname.bluexpinfraprod.eastus2.data.azurecr.io/vm-images/9150.01000024.05090105.vhd+
