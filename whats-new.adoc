...
* サブスクリプションは Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD` 機能に登録されています。https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-saz-feature.html["単一の可用性ゾーンで VMOrchestratorZonalMultiFD を有効にする方法を説明します。"^]。
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-ha-azure.html["Azure の高可用性ペアについて"^]。
