...
| あらゆる種類の仮想マシンに対応。link:reference-configs-azure.html["Azureでサポートされている構成"] 
...
| *サポートされているディスクタイプ* | プレミアム SSD v2 マネージド ディスク | より幅広いサポート。link:reference-configs-azure.html#azure-storage-for-user-data["Azureでサポートされているディスクの種類"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["NetApp Consoleのドキュメント"^]
