...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["最新の権限リストを表示する"^]

.手順
. 以下の API 呼び出しを使用して、Azure サブスクリプション内のキーコンテナーのリストを取得します。
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["HAペアの場合"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["単一ノードの場合"^]: `GET /azure/vsa/metadata/vaults`
...
+
HAペアの場合： `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
単一ノードの場合： `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. HAペアの場合は https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["このAPI呼び出し"^]：
+
...
.. シングルノードシステムの場合は、 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["このAPI呼び出し"^]：
+
...
.関連リンク
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Cloud Volumes ONTAP APIワークフローを使用する準備をしてください"^]。
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["ONTAP管理REST APIについて学ぶ"^]。
