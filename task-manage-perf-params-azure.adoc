...
APIを使用して、Premium SSD v2のディスク設定を変更するプロセスを自動化します。Cloud Volumes ONTAP APIコールの実行については、 https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["最初のAPI呼び出し"^]を参照してください。
...
* https://docs.netapp.com/us-en/console-automation/platform/use_rest_apis.html["Cloud Volumes ONTAPの REST API を使用する"^]
