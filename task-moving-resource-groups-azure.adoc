...
.手順
. Cloud Volumes ONTAP システムを削除します。link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Cloud Volumes ONTAPシステムの削除"]を参照してください。
