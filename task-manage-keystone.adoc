...
. NetApp Consoleメニューから、*管理 >Licenses and subscriptions*を選択します。
. * Keystoneサブスクリプション* を選択します。
. リンクするサブスクリプションで、image:icon-action.png["3つの点が並んだアイコン"] を選択し、*Link*を選択します。
...
. NetApp Consoleメニューから、*管理 >Licenses and subscriptions*を選択します。
. * Keystoneサブスクリプション* を選択します。
. 容量を調整するサブスクリプションについて、image:icon-action.png["3つの点が並んだアイコン"] を選択し、*詳細を表示して編集*を選択します。
. 1 つ以上のサブスクリプションに対して要求されたコミット容量を入力します。
. 下にスクロールし、リクエストに関する追加情報を入力してから、*Submit*を選択してください。
...
. NetApp Consoleメニューから、*管理 >Licenses and subscriptions*を選択します。
. * Keystone*を選択します。
. リンクを解除するサブスクリプションで、image:icon-action.png["3つの点が並んだアイコン"] を選択し、*リンク解除*を選択します。
