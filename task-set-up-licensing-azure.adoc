...
Freemium プランを選択すると、最大 500 GiB のプロビジョニング容量まで Cloud Volumes ONTAP を無料でご利用いただけます。link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["フリーミアムプランの詳細"^]。
...
+
プロビジョニングされた容量が 500 GiB を超えない限り、マーケットプレイスのサブスクリプションを通じて課金されることはありません。超過した場合、システムは自動的に link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["エッセンシャルパッケージ"^] に変換されます。
...
NOTE: NetApp は、BYOLライセンスの購入、延長、更新を制限しています。詳細については、 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAPの BYOL ライセンスの利用制限"^]を参照してください。
...
+
Cloud Volumes ONTAP でライセンスを使用するには、事前にコンソールからライセンスが利用可能な状態になっている必要があります。必要であれば、link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["コンソールにライセンスを手動で追加する"]。
...
TIP: Azure アカウントに関連付けられている Azure Marketplace サブスクリプションは、「設定」>「資格情報」ページから管理できます。 https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Azure アカウントとサブスクリプションを管理する方法を学びます"^]
