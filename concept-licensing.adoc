...
BYOLライセンスは NetApp から購入でき、あらゆるクラウド プロバイダに使用できます。BYOLライセンスの利用可能性に関する詳細については、 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAPの BYOL ライセンスの利用制限"^]を参照してください。
...
* link:link:reference-configs-azure.html["Azureでサポートされている構成"]
...
* link:link:reference-configs-gcp.html["Google Cloud でサポートされている構成"^]
