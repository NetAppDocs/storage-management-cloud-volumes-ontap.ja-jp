...
ライセンスやサブスクリプションの購入または更新は、クラウドマーケットプレイスまたは NetApp （お客様独自のライセンス持ち込み（BYOL））を通じて行うことができます。マーケットプレイスでは、年間サブスクリプションと従量課金制（PAYGO）オプションをご利用いただけます。詳細については、link:concept-license-management.html["Cloud Volumes ONTAPの容量ベースのライセンスの詳細"]を参照してください。
