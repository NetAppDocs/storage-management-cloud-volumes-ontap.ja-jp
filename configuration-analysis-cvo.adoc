...
未解決のディレクティブ（ https://raw.githubusercontent.com/NetAppDocs/console-well-architected/main/cvo/configuration-analysis-cvo.adoc[]）- include::_include/well-architected-workloads.adoc[]
