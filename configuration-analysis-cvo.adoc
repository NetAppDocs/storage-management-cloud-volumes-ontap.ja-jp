...
---
= Well-architected ダッシュボードでの Cloud Volumes ONTAP の構成分析
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
未解決のディレクティブ（ https://raw.githubusercontent.com/NetAppDocs/console-well-architected/main/cvo/configuration-analysis-cvo.adoc[]）- include::well-architected-workloads.adoc[]
