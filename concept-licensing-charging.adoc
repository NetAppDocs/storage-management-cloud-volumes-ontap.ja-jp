...
* BYOLライセンスをお持ちで、マーケットプレイスとの年間契約を結んでいる場合、使用量と超過料金は、お客様が設定した請求設定に従って課金されます。料金の請求方法については、link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["請求設定と超過料金"]を参照してください。
