...
[role="quick-margin-para"]
https://cloud.google.com/apis/docs/getting-started#enabling_apis["プロジェクトで Google Cloud API を有効にする"^]。 https://docs.netapp.com/us-en/console-setup-admin/task-install-agent-google-gcloud.html#step-5-enable-google-cloud-apis["これらのAPI"^]は、コンソールエージェントの作成時に既に有効になっている可能性がありますが、Google CloudにCloud Volumes ONTAPを導入するために必要です。
