...
+
link:https://docs.netapp.com/us-en/data-services-backup-recovery/concept-backup-to-cloud.html["バックアップとリカバリの詳細"^]
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["データ分類の詳細"^]
...
link:https://www.netapp.com/ontap-cloud/["Cloud Volumes ONTAPの詳細"^]
