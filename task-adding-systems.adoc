...
NOTE: コンソールにログインするために使用したアカウントに登録されているシステムのみを追加できます。複数のアカウントまたは組織がある場合は、システムを追加する前に正しいアカウントにログインしていることを確認してください。別のアカウントまたは組織に登録されているシステムを検出、表示、または管理することはできません。
